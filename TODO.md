...
- [ ] **测验/作业/考试的功能**
    ...
    - [x] 题库维护界面
        ...
        - [ ] 新增题目提交字段校验
        - [ ] 更多题目类型
        - [ ] 使用LocalStorage暂存新增的题目，直到题目被提交到后端数据库
    - [ ] 试卷管理界面
        - [ ] 试卷展示界面和新增试卷界面
            - [x] 查看试卷中选项自动生成A/B/C/D
                >   [forloop.counter转换为字母](https://stackoverflow.com/questions/12511992/how-to-get-letters-from-forloop-counter)
                >   [Django自定义标签和过滤器](https://www.liujiangblog.com/course/django/150)
                >   通过自定义过滤器，传入forloop.counter，ascii码转换为ABCD返回
        - [x] 展示题库，可以选择题目组装成试卷
        - [ ] 新增试卷界面可以直接添加题目
        - [x] 保存时被选中的题目引用次数+1
        - [x] 界面样式调整
        ...
        - [ ] 可以查看本课程的学生作答的试卷
        - [ ] 可以批改试卷
        - [ ] 可以设置考试类型(开卷/作业自动批改并即时返回成绩，闭卷/考试手动批改，完成后统一返回成绩)
        - [x] 可以删除试卷
            >   [模态框多次显示并点击确认以后会发送多个ajax请求](https://stackoverflow.com/questions/51402252/jquery-ajax-loaded-multiple-times-after-closing-the-modal)
        - [ ] 试题展示顺序和创建试卷时相同
        - [ ] 可以引用一张旧试卷
    - [ ] 课程学习测试与作业界面
    - [ ] 课程学习考试界面
