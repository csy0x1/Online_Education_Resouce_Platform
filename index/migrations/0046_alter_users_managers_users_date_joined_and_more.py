...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('index', '0045_answersheet_answeredpaper_answersheet_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='selectedOption',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='selectedOption', to='index.questionoption'),
        ),
    ]
