$(document).ready(function () {
	...
	//登录按钮
	$(".LoginBtn")
		.hover(hoverInLogin, hoverOutLogin)
		.click(function () {
	...
	//课程报名按钮
	$(".courseBtn-SignUp")
		.hover(hoverInJoin, hoverOutJoin)
		.click(function () {
			/*
	...
	//开始学习按钮
	$(".courseBtn-Learn")
		.hover(hoverInLearn, hoverOutLearn)
		.click(function () {
	...
	//退出课程按钮
	$(".courseBtn-Resign")
		.hover(hoverInExit, hoverOutExit)
		.click(function () {
			$("#resignConfirm").modal({
				keyboard: true,
			});
	...
	//课程设置按钮
	$(".courseBtn-Setting")
		.hover(hoverInSetting, hoverOutSetting)
		.click(function () {
