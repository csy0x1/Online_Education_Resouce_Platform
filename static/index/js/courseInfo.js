$(document).ready(function () {
    ...
    //课程报名按钮
    $('.courseBtn-SignUp').hover(hoverInJoin, hoverOutJoin).click(function () {
        /*
    ...
    function hoverInJoin() {
        $('.courseBtn-SignUp').animate({ backgroundColor: 'rgb(0,162,216)' }, 50)
    }
    ...
    //开始学习按钮
    $('.courseBtn-Learn').hover(hoverInLearn, hoverOutLearn).click(function () {
        $(location).attr('href', 'learn')
    })
    function hoverInLearn() {
        $('.courseBtn-Learn').animate({ backgroundColor: 'rgb(0,162,216)' }, 50)
    }
    function hoverOutLearn() {
        $('.courseBtn-Learn').animate({ backgroundColor: 'rgb(0,191,255)' }, 50)
    }

    //退出课程按钮
    $('.courseBtn-Resign').hover(hoverInExit, hoverOutExit).click(function () {
        $('#resignConfirm').modal({
            keyboard: true,
        })
